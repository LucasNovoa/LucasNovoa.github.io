...
fetch('https://randomuser.me/api/?gender=male')
      ...
      .then(user => {
        ...
        document.getElementById('city').innerHTML = user.results[0].location.city + ', ' + user.results[0].location.country;
        ...
        document.getElementById('emailReferencias').href = `mailto:${user.results[0].email}?Subject=Hola ${user.results[0].name.first}, me enviarías tus referencias laborales?`;
      });
